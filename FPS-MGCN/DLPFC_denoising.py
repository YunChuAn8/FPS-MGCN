...
adata = sc.read_h5ad('./result/DLPFC/151507/FPS_MGCN.h5ad')
...
sc.pl.stacked_violin(adata, marker_genes, layer='mean', title='FPS-MGCN', groupby='ground_truth', swap_axes=True,
                     figsize=[6, 3], show=False)
plt.savefig(savepath + 'stacked_violin_FPS-MGCN.jpg', bbox_inches='tight', dpi=600)
plt.show()